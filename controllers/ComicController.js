...
const CreateComic = async (req, res, next) => {
    ...
    if (!bookName || !yearOfPublication || !price || !numberOfPages || !condition) {
        const error = new Error("All fields are required: bookName, yearOfPublication, price, numberOfPages, condition.");
